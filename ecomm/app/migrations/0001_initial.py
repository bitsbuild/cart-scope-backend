...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('name',), name='unique_coupon_name')],
            },
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('name',), name='unique_name'), models.UniqueConstraint(fields=('about',), name='unique_about')],
            },
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'product'), name='one_review_per_user')],
            },
        ),
        migrations.AddConstraint(
            model_name='product',
            constraint=models.UniqueConstraint(fields=('seller', 'name'), name='unique_procut_unique_seller_pair'),
        ),
    ]
